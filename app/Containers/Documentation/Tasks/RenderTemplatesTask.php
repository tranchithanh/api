...
class RenderTemplatesTask extends Task
{
    ...
    public function run()
    {
        ...
        $this->headerMarkdown = file_get_contents(app_path(self::TEMPLATE_PATH . 'header.template.md'));
        ...
        file_put_contents($path, $this->headerMarkdown);
